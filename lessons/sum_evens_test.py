...
# make sure to end the test file with test.py
...
def test_sum_positives() -> None:
    """sum_evens_of_lists of a list of positive numbers"""
    test_list: list[int] = [1, 2, 3, 4]
    assert sum_evens_of_list(test_list)

def test_sum_neg_and_positives() -> None:
    """sum_evens_of_lists of list of a list with negatives and positives"""
    test_list: list[int] = [-1, -2, 3, 4]
    assert sum_evens_of_list(test_list) == 2